...
autorest -Input http://localhost:5000/swagger/v1/swagger.json -CodeGenerator CSharp -OutputDirectory ./client/Lykke.AlgoStore.Client/AutorestClient -Namespace Lykke.AlgoStore.Client.AutorestClient
