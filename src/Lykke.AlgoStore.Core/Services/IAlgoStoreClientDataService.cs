...
namespace Lykke.AlgoStore.Core.Services
{
    public interface IAlgoStoreClientDataService
    {
        ...
        Task<AlgoClientMetaData> CreateAlgoAsync(string clientId, string clientName, AlgoMetaData data, string algoContent);
        Task<AlgoClientMetaData> EditAlgoAsync(string clientId, string clientName, AlgoMetaData data, string algoContent);
    }
}
