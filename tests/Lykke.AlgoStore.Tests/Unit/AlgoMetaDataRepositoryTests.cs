...
namespace Lykke.AlgoStore.Tests.Unit
{
    ...
    //                {
    //                    _fixture.Build<AlgoData>().Create()
    //                }
    //            };
    ...
    //        {
    //            return new AlgoMetaDataRepository(AzureTableStorage<AlgoEntity>.Create(SettingsMock.GetTableStorageConnectionString(), AlgoMetaDataRepository.TableName, new LogMock()));
    //        }
