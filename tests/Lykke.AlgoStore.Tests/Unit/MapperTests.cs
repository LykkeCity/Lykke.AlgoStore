...
namespace Lykke.AlgoStore.Tests.Unit
{
    ...
    //    [TestCaseSource("AlgoEntity")]
    //    public void Mapper_AlgoMetaDataEntity_ToModel_Test(AlgoEntity data)
    //    {
    //        AlgoEntity entity = data;

    //        var model = When_Invoke_ToModel(new List<AlgoEntity> { entity });
    ...
    //    private static List<AlgoEntity> When_Invoke_ToEntity(AlgoClientMetaData data)
    //    {
    //        return data.ToEntity();
    //    }
    //    private static AlgoClientMetaData When_Invoke_ToModel(List<AlgoEntity> entities)
    //    {
