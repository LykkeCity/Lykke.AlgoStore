...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapisextensionsv1beta1DeploymentCondition
    {
        ...
        /// transition.</param>
        public Iok8skubernetespkgapisextensionsv1beta1DeploymentCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), System.DateTime? lastUpdateTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
