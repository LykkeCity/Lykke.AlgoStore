...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapiv1ScaleIOVolumeSource
    {
        ...
        /// <param name="protectionDomain">The name of the Protection Domain
        /// for the configured storage (defaults to "default").</param>
        ...
        /// volume should be thick or thin (defaults to "thin").</param>
        /// <param name="storagePool">The Storage Pool associated with the
        /// protection domain (defaults to "default").</param>
        ...
        /// <summary>
        /// Gets or sets the name of the Protection Domain for the configured
        ...
        /// thick or thin (defaults to "thin").
        /// </summary>
        [JsonProperty(PropertyName = "storageMode")]
        public string StorageMode { get; set; }

        /// <summary>
        /// Gets or sets the Storage Pool associated with the protection domain
        /// (defaults to "default").
        /// </summary>
