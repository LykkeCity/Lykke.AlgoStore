...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisrbacv1alpha1RoleRef
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1alpha1RoleRef class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1alpha1RoleRef()
        {
            CustomInit();
        }
        ...
        /// referenced</param>
        public Iok8skubernetespkgapisrbacv1alpha1RoleRef(string apiGroup, string kind, string name)
        {
            ApiGroup = apiGroup;
            Kind = kind;
            Name = name;
