...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapiv1Event
    {
        ...
        public Iok8skubernetespkgapiv1Event(Iok8skubernetespkgapiv1ObjectReference involvedObject, Iok8sapimachinerypkgapismetav1ObjectMeta metadata, string apiVersion = default(string), int? count = default(int?), System.DateTime? firstTimestamp = default(System.DateTime?), string kind = default(string), System.DateTime? lastTimestamp = default(System.DateTime?), string message = default(string), string reason = default(string), Iok8skubernetespkgapiv1EventSource source = default(Iok8skubernetespkgapiv1EventSource), string type = default(string))
        {
