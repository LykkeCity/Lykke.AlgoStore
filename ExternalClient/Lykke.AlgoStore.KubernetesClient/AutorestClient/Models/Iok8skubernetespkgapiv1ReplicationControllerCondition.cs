...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapiv1ReplicationControllerCondition
    {
        ...
        /// transition.</param>
        public Iok8skubernetespkgapiv1ReplicationControllerCondition(string status, string type, System.DateTime? lastTransitionTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
