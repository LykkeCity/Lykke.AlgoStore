...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapiscertificatesv1beta1CertificateSigningRequestCondition
    {
        ...
        public Iok8skubernetespkgapiscertificatesv1beta1CertificateSigningRequestCondition(string type, System.DateTime? lastUpdateTime = default(System.DateTime?), string message = default(string), string reason = default(string))
        {
