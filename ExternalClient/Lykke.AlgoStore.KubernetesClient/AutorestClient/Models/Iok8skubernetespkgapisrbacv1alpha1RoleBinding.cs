...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisrbacv1alpha1RoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1alpha1RoleBinding class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1alpha1RoleBinding()
        {
            CustomInit();
        }
        ...
        public Iok8skubernetespkgapisrbacv1alpha1RoleBinding(Iok8skubernetespkgapisrbacv1alpha1RoleRef roleRef, IList<Iok8skubernetespkgapisrbacv1alpha1Subject> subjects, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
