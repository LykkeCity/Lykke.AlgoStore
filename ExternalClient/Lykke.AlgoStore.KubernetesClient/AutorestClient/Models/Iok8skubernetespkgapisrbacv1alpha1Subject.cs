...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisrbacv1alpha1Subject
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1alpha1Subject class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1alpha1Subject()
        {
            CustomInit();
        }
        ...
        /// error.</param>
        public Iok8skubernetespkgapisrbacv1alpha1Subject(string kind, string name, string apiVersion = default(string), string namespaceProperty = default(string))
        {
