...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    /// </summary>
    public partial class Iok8skubernetespkgapisrbacv1alpha1ClusterRoleBinding
    {
        /// <summary>
        /// Initializes a new instance of the
        /// Iok8skubernetespkgapisrbacv1alpha1ClusterRoleBinding class.
        /// </summary>
        public Iok8skubernetespkgapisrbacv1alpha1ClusterRoleBinding()
        {
            CustomInit();
        }
        ...
        public Iok8skubernetespkgapisrbacv1alpha1ClusterRoleBinding(Iok8skubernetespkgapisrbacv1alpha1RoleRef roleRef, IList<Iok8skubernetespkgapisrbacv1alpha1Subject> subjects, string apiVersion = default(string), string kind = default(string), Iok8sapimachinerypkgapismetav1ObjectMeta metadata = default(Iok8sapimachinerypkgapismetav1ObjectMeta))
        {
        ...
        public Iok8skubernetespkgapisrbacv1alpha1RoleRef RoleRef { get; set; }
        ...
        public IList<Iok8skubernetespkgapisrbacv1alpha1Subject> Subjects { get; set; }
