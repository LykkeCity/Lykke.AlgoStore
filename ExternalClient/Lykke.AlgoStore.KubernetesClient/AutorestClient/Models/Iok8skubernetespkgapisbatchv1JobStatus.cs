...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapisbatchv1JobStatus
    {
        ...
        /// Succeeded.</param>
        public Iok8skubernetespkgapisbatchv1JobStatus(int? active = default(int?), System.DateTime? completionTime = default(System.DateTime?), IList<Iok8skubernetespkgapisbatchv1JobCondition> conditions = default(IList<Iok8skubernetespkgapisbatchv1JobCondition>), int? failed = default(int?), System.DateTime? startTime = default(System.DateTime?), int? succeeded = default(int?))
        {
            Active = active;
