...
namespace Lykke.AlgoStore.KubernetesClient.Models
{
    ...
    public partial class Iok8skubernetespkgapispolicyv1beta1PodDisruptionBudgetStatus
    {
        ...
        /// Iok8skubernetespkgapispolicyv1beta1PodDisruptionBudgetStatus class.
        /// </summary>
        ...
        public Iok8skubernetespkgapispolicyv1beta1PodDisruptionBudgetStatus(int currentHealthy, int desiredHealthy, IDictionary<string, System.DateTime?> disruptedPods, int disruptionsAllowed, int expectedPods, long? observedGeneration = default(long?))
        {
